function filename=create_cas(Main_folder,startimage,endimage,index)
...
string=[Main_folder(1:end-length('\Renamed')),'\Vectors\bs',startimage((end-length('*****a.tif')):(end-length('***a.tif')))];
fprintf( fid,'%s\n',string );
